...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4 d-none" id="table_title">قائمة الاضافات</h4>
        <div class="card">
                ...
                <div id="DataTables_Table_0_wrapper" class="container dataTables_wrapper  dt-bootstrap5 no-footer">
                    <div id="table_header" class="card-header flex-column flex-md-row">
                        <div class="head-label text-center">
                            <h5 class="card-title mb-0">قائمة الاضافات</h5>
                        </div>
                    </div>
                    <form class="d-flex " action="{{ route('increased product date') }}" method="POST">
                        @csrf
                    ...
                    <table id="data_table" class="datatables-basic table table-hover">
                        ...
                        <tbody>
                            @if (!empty($increased_products))
                                @foreach ($increased_products as $product)
                                    <tr>
